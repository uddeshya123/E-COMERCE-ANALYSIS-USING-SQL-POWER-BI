...
--CUSTOMERS NAME WHO SPEND MORE MONEY--
SELECT C.NAME,SUM(P.PRICE * OI.QUANTITY) AS C_SPEND
FROM ORDERS O
...
SELECT SUM(OI.QUANTITY) AS CANCELLED_ORDER
FROM ORDER_ITEMS OI
INNER JOIN ORDERS O ON OI.ORDER_ID=O.ORDER_ID
